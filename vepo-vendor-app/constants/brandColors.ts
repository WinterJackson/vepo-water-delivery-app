/**
 * ╔═══════════════════════════════════════════════════════════════╗
 * ║  VEPO BRAND COLOR SYSTEM — Easy to change!                   ║
...
// ── Core Brand Colors ─────────────────────────────────────────────
export const BRAND = {
  /** Vepo's primary brand color */
  primary: '#0295f7',
  /** Vepo's signature gold — the anchor for all gradients */
  gold: '#0295f7',
  ...
  favorite: '#ef4444',
  /** Outline color for borders (Customer App compatibility) */
  outline: '#d1d5db',
} as const;
