...
def _base_template(content: str, preheader: str = "") -> str:
    """
    Vepo branding wrapper for all emails.
    """
    return f"""
    <!DOCTYPE html>
    <html>
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                ...
                <h1 style="margin: 0; color: #d9a31b; font-size: 28px;">Vepo</h1>
            </div>
            <div class="content">
                {content}
            </div>
            <div class="footer">
                &copy; 2026 Vepo &middot; Nairobi, Kenya<br>
                This email was sent to you because you're a registered user of Vepo.
            </div>
        </div>
    </body>
    </html>
...
def welcome_customer(name: str) -> str:
    content = f"""
        <h2 style="margin-top:0;">Welcome to Vepo, {name}! 💧</h2>
        <p>We're thrilled to have you here. Vepo makes it incredibly easy to get water delivered straight to your door from trusted vendors.</p>
    ...
    """
    return _base_template(content, preheader="Welcome to the Vepo community!")

def welcome_vendor(name: str, business: str) -> str:
    content = f"""
        <h2 style="margin-top:0;">Welcome aboard, {name}! 🤝</h2>
        <p>Thank you for registering <strong>{business}</strong> with Vepo.</p>
    ...
    """
    return _base_template(content, preheader="Your Vepo Vendor application is under review.")

def welcome_rider(name: str) -> str:
    content = f"""
        <h2 style="margin-top:0;">Welcome to the Vepo Delivery Network, {name}! 🚲</h2>
        <p>Thanks for signing up to deliver with Vepo.</p>
        ...
        <p>We'll notify you as soon as your account is verified.</p>
    """
    return _base_template(content, preheader="Your Vepo Rider application is under review.")
...
def password_reset(name: str, code: str) -> str:
    ...
    """
    return _base_template(content, preheader=f"Your Vepo reset code is {code}")
...
def order_confirmation(name: str, order: Dict[str, Any]) -> str:
    content = f"""
        ...
        <p>You can track the status of your order in the Vepo Customer App.</p>
    """
    return _base_template(content, preheader="Your Vepo order has been confirmed.")
...
def vendor_approved(name: str) -> str:
    content = f"""
        ...
        <p>You can now log into the Vepo Vendor app, list your products, and start receiving orders today.</p>
        <div style="text-align: center; margin: 30px 0;">
            <a href="#" class="btn">Open Vendor App</a>
        </div>
    """
    return _base_template(content, preheader="Your Vepo Vendor account has been approved.")
...
def rider_approved(name: str) -> str:
    content = f"""
        ...
        <p>You can now log into the Vepo Rider app, go online, and start accepting delivery requests.</p>
        <div style="text-align: center; margin: 30px 0;">
            <a href="#" class="btn">Open Rider App</a>
        </div>
    """
    return _base_template(content, preheader="Your Vepo Rider account has been approved.")
