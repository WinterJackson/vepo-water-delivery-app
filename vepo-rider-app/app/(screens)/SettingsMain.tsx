...
export default function SettingsMain() {
    ...
    const handleDeleteAccount = () => {
        ...
        Popup.show({
            ...
            message: "Your rider profile, vehicle records, and personal identifiers will be permanently removed. You will be deactivated from the Vepo fleet. Past payouts and delivery history will be strictly anonymized. This action is irreversible. Proceed?",
            cancelText: "Cancel",
            confirmText: "Delete",
            isDestructive: true,
            onConfirm: async () => {
